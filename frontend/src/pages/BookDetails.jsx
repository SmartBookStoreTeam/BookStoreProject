  ...
  if(error||!book){
    return(
        <div className="pt-20 flex items-center justify-center dark:bg-zinc-900 py-20">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200 mb-2">Something went wrong</h2>
            <p className="text-gray-600 dark:text-gray-200 mb-6">{error||"We're sorry, but we couldn't load the book details. Please try again later."}</p>
            <button className="bg-gray-800 dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition-colors cursor-pointer" onClick={()=>navigate(-1)}>Go Back</button>
            ...
            <div className="flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded-lg dark:bg-gray-800">
                {book.isbn && (
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-gray-200">{book.isbn}</p>
                  </div>
                )}
                {book.edition && (
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-200">Edition:</span>
                    <p className="font-medium text-gray-900 dark:text-gray-200">{book.edition}</p>
                  </div>
                )}
                {book.publicationYear && (
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-200">Year:</span>
                ...
                {book.pages && (
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-200">Pages:</span>
              ...
              {book.sellerName && (
                <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  {book.sellerLocation && (
                    <p className="text-sm text-gray-600">{book.sellerLocation}</p>
                  )}
                </div>
              )}
