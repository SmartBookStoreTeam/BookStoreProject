...
useEffect(() => {
  ...
  const handleAddToCart = (book) => {
    ...
    addToCart(book);
    toast.success(
      `${t("toCart", "Added")} "${book.title}" ${t("added", "to cart")}`,
      {
        duration: 1500,
        style: {
          background: "#333",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden dark:bg-[#1a1a22]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            ${
              value <= (book.hoverRating||book.rate || book.userRating || book.ratings)
          ...
          `}
                        ...
                        onClick={() => setBook({ ...book, userRating: value })}
                      />
                    );
                  })}
                </div>
