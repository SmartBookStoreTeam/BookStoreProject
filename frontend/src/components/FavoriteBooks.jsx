      ...
      <div className="container mx-auto px-6 md:px-20 py-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight mb-6 transition-colors duration-300">
              Find Your Favorite <br /> <span className="text-indigo-500 dark:text-indigo-400 transition-colors duration-300">Book Here!</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-6 mb-8 max-w-md mx-auto lg:mx-0">
              <div>
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">Book Listing</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">Register User</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">Books Sold</div>
              </div>
            </div>
