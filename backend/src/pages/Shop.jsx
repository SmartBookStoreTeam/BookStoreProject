...
const Shop = () => {
  const { addToCart, cartItems, userBooks } = useCart();
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Book Shop</h1>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500"
              />
            </div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <select
                ...
                className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent min-w-48"
              >
              ...
              <div
                ...
                className={
                  viewMode === "grid"
                    ...
                    : "bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex"
                }
              >
                {/* Book Image */}
                <div
                ...
                <div className={viewMode === "grid" ? "p-4" : "p-6 flex-1"}>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="inline-block bg-indigo-100 text-indigo-800 text-xs font-medium px-2 py-1 rounded-full capitalize">
                      {book.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-1 mb-3">
                    ...
                    <span className="text-sm text-gray-500">({book.rate})</span>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-2 rounded-lg flex items-center justify-center gap-2 transition"
                  >
